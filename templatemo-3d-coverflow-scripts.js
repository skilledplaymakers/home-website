...
// JavaScript Document
        ...
        const imageData = [
            ...
            {
                title: "SKILLED PLAYMAKERS",
                description: "SKILLED IN EXECUTION, SMART IN STRATEGY"
            },
            {
                title: "EVENT MANAGER",
                description: "Joana Balagot"
            },
            {
                title: "ASS. EVENT MANAGER",
                description: "Ervine Cayanan"
            },
            {
                title: "EVENT COORDINATORS",
                description: "Jaylene Lansang, Erica Almanzar"
            },
            {
                title: "INFORMATION MANAGERS",
                description: "Richard Dela Cruz, Xyrel Tamondong"
            },
            {
                title: "LOGISTIC MANAGERS",
                description: "Jomar De Guzman, Daniela Santiago"
            },
            {
                title: "INFRASTRUCTURE MANAGERS",
                description: "Harvey Zabala, Eltrisha Lee Franco, Ezra Guadayo"
            },
            {
                title: "SECURITY MANAGERS",
                description: "Francine Shyly Logrosa, Whesly Mandap, Jeremy Zoleta"
            }
        ];
